...
<head>
    ...
    <button class="btn-outline-success my-2 my-sm-0" onclick="history.go(-1);">Back </button>
       ...
       <form class="loginform" action="identify.php">
        <div class="login">
            <div class="login-screen">
                ...
                <div class="login-form">
                    ...
                    <input type="submit" class="btn btn-primary btn-large btn-block" value="Login" href="#" style="background-color: gold;"></input>
